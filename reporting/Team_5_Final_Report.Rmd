...
![Industry Business Density vs. Star Ratings ](../gen/output/avg_rating_vs_industry_business_density.pdf)
...
```{r echo=FALSE}
cat(readLines("../gen/output/base_regression.txt"), sep = "\n")
```
...
```{r echo=FALSE}
cat(readLines("../gen/output/regression_with_categories_summary.txt"), sep = "\n")
```
...
```{r echo=FALSE}
cat(readLines("../gen/output/results_by_industry.txt"), sep = "\n")
```
